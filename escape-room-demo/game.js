...
const secretKey = 13;
const teacherPasswordHash = "4f303e3edea354e0ea10595b46def642542c124e291d638051bf0bb10de9edd7";
...
function okNum(id,val) {
  ...
  const tol = Math.max(0.05, Math.abs(val) * 0.005); // 0.5% or 0.05
...
async function skipLevel() {
  ...
  if (codeHash !== teacherPasswordHash) return;
  if (!hasStarted()) {
    startTimer();
  }
